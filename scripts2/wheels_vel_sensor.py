...
from eod.msg import Wheels_Vel

class WheelsVelSensor():
	"""docstring for WheelsVel"""
	def __init__(self):
		rospy.init_node('eod/wheels_vel_sensor')

		# ------ PARAMETRI ------
		# frequenza del loop 
		self.freq = rospy.get_param('eod/loop_freq/wheels_vel', 0.1)
		...
		rospy.Subscriber('eod/tick_dx', Byte, self.tick_dx_callback)
		rospy.Subscriber('eod/tick_sx', Byte, self.tick_sx_callback)
		
		self.pub_vel = rospy.Publisher('eod/wheels_velocity', Wheels_Vel, queue_size=10)
